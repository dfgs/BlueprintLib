...
namespace BlueprintLib
{
	...
	public class CodeGenerator : IIncrementalGenerator
	{
		...
		public const string UsingAttributeName = "UsingAttribute";
		public const string UsingFullAttributeName = $"{Namespace}.{UsingAttributeName}";
		...
		""";
		private string UsingAttributeSourceCode =
		$$"""
		// <auto-generated/>
		using System;
		...
		{
			[AttributeUsage(AttributeTargets.Class | AttributeTargets.Interface, AllowMultiple = true)]
			internal class {{UsingAttributeName}} : Attribute
			{
				...
				public {{UsingAttributeName}}(string Namespace)
				{
		...
		public void Initialize(IncrementalGeneratorInitializationContext context)
		{
			...
			context.RegisterPostInitializationOutput(incrementalGeneratorPostInitializationContext => incrementalGeneratorPostInitializationContext.AddSource($"Attributes/{UsingAttributeName}.g.cs", SourceText.From(UsingAttributeSourceCode, Encoding.UTF8)));
		...
		private void GenerateDynamicSources(SourceProductionContext SourceProductionContext,ProjectDefinition ProjectDefinition, ImmutableArray<Blueprint> Blueprints)
		{
			...
			scriptObject.Import("with_name", (IEnumerable<INamed> items, string name) => items.WithName(name).ToArray());
